...
public class ApisApi  {
   ...
   private final ApisApiService delegate = ApisApiServiceFactory.getApisApi();
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.\nRequested resource policy definition of the API is returned\n"),
    ...
    @Consumes({ "multipart/form-data" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Update the resource policy(inflow/outflow) definitions", notes = "This operation can be used to update the resource policy(inflow/outflow) definitions of an existing API. resource policy definition to be updated is passed as a form data parameter `content`.\n", response = void.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    public Response apisApiIdResourcePoliciesPut(@ApiParam(value = "**API ID** consisting of the **UUID** of the API. Using the **UUID** in the API call is recommended.\nThe combination of the provider of the API, name of the API and the version is also accepted as a valid API ID.\nShould be formatted as **provider-name-version**.\n",required=true ) @PathParam("apiId") @Encoded String apiId,
    @ApiParam(value = "Resource id of the the resource policy definition resource", required=true )@Multipart(value = "id")  String id,
    @ApiParam(value = "SOAP to REST Generated resource policy definition to be updated of the API", required=true )@Multipart(value = "content")  String content,
    @ApiParam(value = "Media type of the entity in the body. Default is application/json.\n" ,required=true , defaultValue="application/json")@HeaderParam("Content-Type") String contentType,
    @ApiParam(value = "Validator for conditional requests; based on ETag (Will be supported in future).\n"  )@HeaderParam("If-Match") String ifMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header (Will be supported in future).\n"  )@HeaderParam("If-Unmodified-Since") String ifUnmodifiedSince)
    {
    return delegate.apisApiIdResourcePoliciesPut(apiId,id,content,contentType,ifMatch,ifUnmodifiedSince);
    }
    @GET
    @Path("/{apiId}/swagger")
    @Consumes({ "application/json" })
