    ...
    public static boolean isSOAPToRESTApi(String name, String version, String provider) throws APIManagementException {
        ...
        try {
            ...
            try {
                ...
                String resourcePath = APIConstants.API_LOCATION + RegistryConstants.PATH_SEPARATOR + APIUtil
                        .replaceEmailDomain(provider) + RegistryConstants.PATH_SEPARATOR + name
