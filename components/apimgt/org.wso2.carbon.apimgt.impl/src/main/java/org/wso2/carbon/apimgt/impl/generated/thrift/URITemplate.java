...
public class URITemplate implements org.apache.thrift.TBase<URITemplate, URITemplate._Fields>, java.io.Serializable, Cloneable, Comparable<URITemplate> {
  ...
  private static final org.apache.thrift.protocol.TField THROTTLING_TIERS_FIELD_DESC = new org.apache.thrift.protocol.TField("throttlingTiers", org.apache.thrift.protocol.TType.LIST, (short)10);
  ...
  public List<String> throttlingTiers; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    THROTTLING_TIERS((short)10, "throttlingTiers");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 10: // THROTTLING_TIERS
          return THROTTLING_TIERS;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.URI_TEMPLATE,_Fields.RESOURCE_URI,_Fields.RESOURCE_SANDBOX_URI,_Fields.HTTP_VERB,_Fields.AUTH_TYPE,_Fields.THROTTLING_TIER,_Fields.THROTTLING_CONDITIONS,_Fields.APPLICABLE_LEVEL,_Fields.CONDITION_GROUPS,_Fields.THROTTLING_TIERS};
  ...
  static {
    ...
    tmpMap.put(_Fields.THROTTLING_TIERS, new org.apache.thrift.meta_data.FieldMetaData("throttlingTiers", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
  ...
  public URITemplate(URITemplate other) {
    ...
    if (other.isSetThrottlingConditions()) {
      List<String> __this__throttlingConditions = new ArrayList<String>(other.throttlingConditions);
    ...
    if (other.isSetConditionGroups()) {
      List<ConditionGroupDTO> __this__conditionGroups = new ArrayList<ConditionGroupDTO>(other.conditionGroups.size());
    ...
    if (other.isSetThrottlingTiers()) {
      List<String> __this__throttlingTiers = new ArrayList<String>(other.throttlingTiers);
      this.throttlingTiers = __this__throttlingTiers;
    }
  }
  ...
  public int getThrottlingTiersSize() {
    return (this.throttlingTiers == null) ? 0 : this.throttlingTiers.size();
  }

  public java.util.Iterator<String> getThrottlingTiersIterator() {
    return (this.throttlingTiers == null) ? null : this.throttlingTiers.iterator();
  }

  public void addToThrottlingTiers(String elem) {
    if (this.throttlingTiers == null) {
      this.throttlingTiers = new ArrayList<String>();
    }
    this.throttlingTiers.add(elem);
  }
  ...
  public URITemplate setThrottlingTiers(List<String> throttlingTiers) {
    this.throttlingTiers = throttlingTiers;
    return this;
  }

  public void unsetThrottlingTiers() {
    this.throttlingTiers = null;
  }

  /** Returns true if field throttlingTiers is set (has been assigned a value) and false otherwise */
  public boolean isSetThrottlingTiers() {
    return this.throttlingTiers != null;
  }

  public void setThrottlingTiersIsSet(boolean value) {
    if (!value) {
      this.throttlingTiers = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case THROTTLING_TIERS:
      if (value == null) {
        unsetThrottlingTiers();
      } else {
        setThrottlingTiers((List<String>)value);
      }
      break;
  ...
  public boolean equals(URITemplate that) {
    ...
    boolean this_present_throttlingTiers = true && this.isSetThrottlingTiers();
    boolean that_present_throttlingTiers = true && that.isSetThrottlingTiers();
    if (this_present_throttlingTiers || that_present_throttlingTiers) {
      if (!(this_present_throttlingTiers && that_present_throttlingTiers))
        return false;
  ...
  public int hashCode() {
    ...
    boolean present_throttlingConditions = true && (isSetThrottlingConditions());
    list.add(present_throttlingConditions);
    if (present_throttlingConditions)
      list.add(throttlingConditions);

    boolean present_applicableLevel = true && (isSetApplicableLevel());
    list.add(present_applicableLevel);
    if (present_applicableLevel)
      list.add(applicableLevel);

    boolean present_conditionGroups = true && (isSetConditionGroups());
    list.add(present_conditionGroups);
    if (present_conditionGroups)
      list.add(conditionGroups);

    boolean present_throttlingTiers = true && (isSetThrottlingTiers());
    list.add(present_throttlingTiers);
    if (present_throttlingTiers)
      list.add(throttlingTiers);
  ...
  public int compareTo(URITemplate other) {
    ...
    lastComparison = Boolean.valueOf(isSetThrottlingTiers()).compareTo(other.isSetThrottlingTiers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThrottlingTiers()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.throttlingTiers, other.throttlingTiers);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetThrottlingTiers()) {
      if (!first) sb.append(", ");
      sb.append("throttlingTiers:");
      if (this.throttlingTiers == null) {
        sb.append("null");
      } else {
        sb.append(this.throttlingTiers);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class URITemplateStandardScheme extends StandardScheme<URITemplate> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.throttlingTiers = new ArrayList<String>(_list38.size);
                String _elem39;
                for (int _i40 = 0; _i40 < _list38.size; ++_i40)
                {
                  _elem39 = iprot.readString();
                  struct.throttlingTiers.add(_elem39);
                }
                iprot.readListEnd();
              }
              struct.setThrottlingTiersIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, URITemplate struct) throws org.apache.thrift.TException {
      ...
      if (struct.throttlingConditions != null) {
        if (struct.isSetThrottlingConditions()) {
          oprot.writeFieldBegin(THROTTLING_CONDITIONS_FIELD_DESC);
          {
            ...
            for (String _iter41 : struct.throttlingConditions)
            {
      ...
      if (struct.conditionGroups != null) {
        if (struct.isSetConditionGroups()) {
          oprot.writeFieldBegin(CONDITION_GROUPS_FIELD_DESC);
          {
            ...
            for (ConditionGroupDTO _iter42 : struct.conditionGroups)
            {
              _iter42.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.throttlingTiers != null) {
        if (struct.isSetThrottlingTiers()) {
          oprot.writeFieldBegin(THROTTLING_TIERS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.throttlingTiers.size()));
            for (String _iter43 : struct.throttlingTiers)
            {
  ...
  private static class URITemplateTupleScheme extends TupleScheme<URITemplate> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, URITemplate struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetThrottlingConditions()) {
        {
          ...
          for (String _iter44 : struct.throttlingConditions)
          {
      ...
      if (struct.isSetConditionGroups()) {
        {
          ...
          for (ConditionGroupDTO _iter45 : struct.conditionGroups)
          {
            _iter45.write(oprot);
          }
        }
      ...
      if (struct.isSetThrottlingTiers()) {
        {
          oprot.writeI32(struct.throttlingTiers.size());
          for (String _iter46 : struct.throttlingTiers)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.throttlingConditions = new ArrayList<String>(_list47.size);
          String _elem48;
          for (int _i49 = 0; _i49 < _list47.size; ++_i49)
          {
            _elem48 = iprot.readString();
            struct.throttlingConditions.add(_elem48);
          }
        }
        struct.setThrottlingConditionsIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.conditionGroups = new ArrayList<ConditionGroupDTO>(_list50.size);
          ConditionGroupDTO _elem51;
          for (int _i52 = 0; _i52 < _list50.size; ++_i52)
          {
            _elem51 = new ConditionGroupDTO();
            _elem51.read(iprot);
            struct.conditionGroups.add(_elem51);
          }
        }
        struct.setConditionGroupsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.throttlingTiers = new ArrayList<String>(_list53.size);
          String _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = iprot.readString();
            struct.throttlingTiers.add(_elem54);
          }
        }
        struct.setThrottlingTiersIsSet(true);
      }
